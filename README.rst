...
.. _`使用Docker容器安装`: ./Documents/installation_cn.rst
.. _`使用离线包安装`: ./Documents/installation_premise_cn.rst
.. _`Kyligence Insight for Superset 使用手册`: ./Documents/user_manual_cn/superset_cn.rst
.. _`Installing from Docker container`: ./Documents/installation_en.rst
.. _`Installing from offline package`: ./Documents/installation_premise_en.rst
